...
<container class="container sticky-bottom my-auto">
    <footer class="pt-4 mt-4 footer mt-auto sticky-bottom">
        <ul class="nav justify-content-center  pb-3 mb-3">

            <li class="nav-item"><a href="#" class="nav-link px-1 text-muted">Activités</a></li>
            <li class="nav-item"><a href="#" class="nav-link px-1 text-muted">Programmes</a></li>
        ...
        <div class="d-flex justify-content-between py-4 my-4 border-top">
            ...
            <ul class="list-unstyled d-flex mx-auto">
                ...
                <li class="ms-3"><a class="link-dark " href="https://www.facebook.com/ihi.asso"><svg class="bi social_ic" width="100" height="100">
